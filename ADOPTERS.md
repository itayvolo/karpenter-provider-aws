...
| SternumIOT | Using Karpenter to efficiently autoscale our EKS clusters, optimizing node lifecycle management for both performance and cost-effectiveness across our Kubernetes workloads | `@itayvolo`, `@amitd` | [SternumIOT](https://sternumiot.com/) |
